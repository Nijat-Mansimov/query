...
const ruleSchema = new mongoose.Schema({
  ...
  queryLanguage: {
    type: String,
    required: true,
    enum: ['SIGMA', 'KQL', 'SPL', 'YARA', 'SURICATA', 'SNORT', 'LUCENE', 'ESQL', 'SQL', 'XQL', 'CUSTOM']
  },
  vendor: {
    type: String,
    required: true,
    enum: ['ELASTIC', 'SPLUNK', 'MICROSOFT_SENTINEL', 'CHRONICLE', 'QRADAR', 'ARCSIGHT', 'SUMO_LOGIC', 'PALO_ALTO_XDR', 'PALO_ALTO_XSIAM', 'GENERIC']
  },
  category: {
    type: String,
    required: true,
    enum: ['DETECTION', 'HUNTING', 'CORRELATION', 'ENRICHMENT', 'RESPONSE', 'MONITORING', 'FORENSICS']
  },
  tags: [{
    type: String,
    trim: true,
