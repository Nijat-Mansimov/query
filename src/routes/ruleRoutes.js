...
const { authenticate, hasPermission, isOwnerOr, optionalAuth, requireEmailVerification } = require('../middleware/auth');
...
router.get('/',
  ...
  [
    ...
    query('queryLanguage').optional().isIn(['SIGMA', 'KQL', 'SPL', 'YARA', 'SURICATA', 'SNORT', 'LUCENE', 'ESQL', 'SQL', 'XQL', 'CUSTOM']),
    query('vendor').optional().isIn(['ELASTIC', 'SPLUNK', 'MICROSOFT_SENTINEL', 'CHRONICLE', 'QRADAR', 'ARCSIGHT', 'SUMO_LOGIC', 'PALO_ALTO_XDR', 'PALO_ALTO_XSIAM', 'GENERIC']),
    query('category').optional().isIn(['DETECTION', 'HUNTING', 'CORRELATION', 'ENRICHMENT', 'RESPONSE', 'MONITORING', 'FORENSICS']),
...
router.post('/',
  ...
  [
    ...
    body('queryLanguage')
      .isIn(['SIGMA', 'KQL', 'SPL', 'YARA', 'SURICATA', 'SNORT', 'LUCENE', 'ESQL', 'SQL', 'XQL', 'CUSTOM'])
      .withMessage('Invalid query language'),
    body('vendor')
      .isIn(['ELASTIC', 'SPLUNK', 'MICROSOFT_SENTINEL', 'CHRONICLE', 'QRADAR', 'ARCSIGHT', 'SUMO_LOGIC', 'PALO_ALTO_XDR', 'PALO_ALTO_XSIAM', 'GENERIC'])
      .withMessage('Invalid vendor'),
    body('category')
      .isIn(['DETECTION', 'HUNTING', 'CORRELATION', 'ENRICHMENT', 'RESPONSE', 'MONITORING', 'FORENSICS'])
